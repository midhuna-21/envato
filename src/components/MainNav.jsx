      ...
      <div className="max-w-[1891px] mx-auto px-30 py-1 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          <div className="flex items-center gap-4 text-[#d4d1c7]">
            <FaTwitter size={16} className="opacity-90" />
            <FaFacebookF size={16} className="opacity-90" />
            <FaSkype size={16} className="opacity-90" />
            <FaRss size={16} className="opacity-90" />
            <FaInstagram size={16} className="opacity-90" />
          </div>
