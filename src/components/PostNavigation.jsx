        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="flex">
            ...
            <div className="w-12 bg-gray-100 flex items-center justify-center text-2xl text-gray-700">
                 <Link href={`/${otherArticles[0].category}/${otherArticles[0].slug}`} className="text-decoration-none" title={otherArticles[0].title}>
              &laquo;
              </Link>
            </div>
           ...
           <span className="uppercase text-[13px] text-[#c1c0b4] font-serif ">
              ...
              <Link href={`/${otherArticles[0].category}/${otherArticles[0].slug}`} className="text-decoration-none" title={otherArticles[0].title}>
                <h3 className="text-[26px] leading-[1.1] tracking-tight mt-1 font-medium line-clamp-2">
          ...
          <div className="flex border-t md:border-t-0 md:border-l">
            <div className="flex-1 p-4">
              ...
              <Link href={`/${otherArticles[0].category}/${otherArticles[0].slug}`} className="text-decoration-none" title={otherArticles[0].title}>
                <h3 className="text-[26px] mt-1 leading-[1.1] tracking-tight font-medium line-clamp-2">
