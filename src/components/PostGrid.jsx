        ...
        {data.map((item) => (
          <div key={item.slug} className="text-center">
            ...
            <div className="relative group">
              ...
              {/* CATEGORY LABEL — reduced drop height */}
            ...
            {/* TITLE — compact spacing + no ellipsis */}
            <h2
              className="mt-5 text-[26px] font-light text-[#2f2f2f] leading-snug"
              style={{
                display: "-webkit-box",
                WebkitLineClamp: 2,
            ...
            <div className="mt-1 mb-1 text-[#2f2f2f] font-normal text-sm flex justify-center items-center gap-3">
              <span>{item.date}</span>
            </div>
