...
export default function HeroSection({ data }) {
  ...
  "
        >
          <h1 className="text-sm md:text-6xl text-[#2f2f2f] capitalize font-light tracking-wide md:mb-5 mb-1">
          ...
          <p className="opacity-90 text-[6px] md:text-[13px] font-semibold text-[#2f2f2f] font-serif mb-2 md:mb-8">
            {currentSlide.title}
          </p>
          <div
