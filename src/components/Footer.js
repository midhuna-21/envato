  ...
  return (
    <footer className="bg-[#2f2f2f] text-gray-200 py-16 px-6">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
        ...
        {/* LATEST POSTS */}
        <div>
          <h3 className="text-2xl font-semibold tracking-wide mb-2">LATEST POSTS</h3>
          <div className="w-12 h-[1px] bg-gray-400 mx-auto mb-6"></div>
          ...
          <div className="mb-8">
            <img
              src="/post1.jpg"
              className="w-full mx-auto border border-gray-500"
            />
            <p className="mt-2 font-medium text-sm">31 December, 2014</p>
            <p className="text-sm mt-1">
              Vivamus massa urna, feugiat et sapien at,
              volutpat convallis arcu.
            </p>
            <div className="mt-3"><span>◆</span></div>
          </div>
          ...
          <div>
            <img
              ...
              className="w-full mx-auto border border-gray-500"
            />
            <p className="mt-2 font-medium text-sm">02 November, 2014</p>
            <p className="text-sm mt-1">
              Maecenas mollis turpis at sagittis sodales.
              Phasellus nec commodo.
            </p>
          </div>
        </div>
